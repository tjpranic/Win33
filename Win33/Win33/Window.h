...
namespace Win33 {
    ...
    class Window {
    public:
        DECLARE_EVENT( Destroy,    void( ),                        Window )
        DECLARE_EVENT( Close,      void(       bool&  cancelled ), Window )
        DECLARE_EVENT( Resize,     void( const Size&  size ),      Window )
        DECLARE_EVENT( Move,       void( const Point& position ),  Window )
        DECLARE_EVENT( LeftClick,  void( const Point& position ),  Window )
        DECLARE_EVENT( RightClick, void( const Point& position ),  Window )
        DECLARE_EVENT( KeyDown,    void(       Key    key ),       Window )
        DECLARE_EVENT( KeyUp,      void(       Key    key ),       Window )
